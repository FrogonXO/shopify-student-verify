...
<html>
  <head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="viewport" content="width=device-width" />
    <title>Reminder: Bildungsstatus verifizieren</title>
    <style>
      body { margin: 0; padding: 0; background: #ffffff; }
      a { text-decoration: none; }
      a:hover { text-decoration: none; }
  ...
  <body style="margin:0; padding:0;" class="font">
    <div class="preheader">
      Bitte verifiziere deinen Bildungsstatus innerhalb der nächsten 48 Stunden auf verify.edubook.at.
    </div>
        ...
        <td class="font" style="padding: 40px 0 0;">
          <table class="container" role="presentation" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td class="font stack right" align="right" style="vertical-align: middle; text-transform: uppercase; font-size: 14px; color: #999;">
                <span style="font-size: 16px;">Reminder</span>
              </td>
            </tr>
          </table>
              ...
              <td class="font" style="padding: 26px 0 40px;">
                <table class="container" role="presentation" cellpadding="0" cellspacing="0">
                  <tr>
                    <td class="font">
                      <h2 style="font-weight: normal; font-size: 24px; margin: 0 0 10px;">
                        Bitte verifiziere deinen Bildungsstatus
                      </h2>

                      <p class="muted" style="line-height: 150%; font-size: 16px; margin: 0;">
                        Reminder: bitte verifiziere deinen Bildungsstatus, damit wir deine edubook-Bestellung durchführen können.
                        Bitte gehe innerhalb der nächsten 48 Stunden auf verify.edubook.at, um die Verifizierung durchzuführen.
                      </p>

                      <table role="presentation" cellpadding="0" cellspacing="0" style="margin-top: 22px;">
                        <tr>
                          <td class="font" align="left">
                            <a class="btn" href="https://verify.edubook.at/verify" target="_blank" rel="noopener">
                              Jetzt Bildungsstatus verifizieren
                            </a>
                          </td>
                        </tr>
                      </table>
                      ...
                      <p class="muted" style="line-height: 150%; font-size: 16px; margin: 18px 0 0;">
                        oder direkt hier:
                        <a href="https://verify.edubook.at/verify" style="color:#38B28D; font-size:16px;" target="_blank" rel="noopener">
                          https://verify.edubook.at/verify
                        </a>
                      </p>
                    </td>
                  </tr>
